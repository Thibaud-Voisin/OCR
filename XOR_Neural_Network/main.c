...
//	scanf("%lf",&precision);	
	...
	Neural_network Xor = Init_neural_network(input,input_layer_neurons,hidden_layer_neurons,output_layer_neurons);
	Pretty_print(Xor.hidden_weight);	
